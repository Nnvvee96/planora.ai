...
const VanillaEarthScene: React.FC = () => {
  ...
  useEffect(() => {
    ...
    continentGeometry.setAttribute(
      "position",
      new THREE.Float32BufferAttribute(continentPositions, 3),
    );
    continentGeometry.setAttribute(
      "color",
      new THREE.Float32BufferAttribute(continentColors, 3),
    );
    ...
    const continentParticles = new THREE.Points(
      continentGeometry,
      continentMaterial,
    );
    ...
    oceanGeometry.setAttribute(
      "color",
      new THREE.Float32BufferAttribute(oceanColors, 3),
    );
    ...
    const animate = () => {
      ...
      if (continentParticles) {
        (continentParticles.material as THREE.PointsMaterial).opacity =
          0.9 + Math.sin(time * 1.5) * 0.1;
      }

      if (oceanParticles) {
        (oceanParticles.material as THREE.PointsMaterial).opacity =
          0.6 + Math.sin(time * 2.0) * 0.2;
      }
