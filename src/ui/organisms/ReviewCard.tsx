...
export const ReviewCard = ({
  ...
  return (
    <div
      className={cn(
        "bg-gradient-to-br from-black/60 to-planora-purple-dark/40 backdrop-blur-xl border border-white/10 rounded-xl shadow-lg p-6 h-full flex flex-col justify-between min-h-[280px] max-w-sm mx-auto",
        className,
      )}
    >
      <div>
        <div className="flex items-center mb-4">
          {authorAvatarUrl ? (
            <img
              ...
              className="w-12 h-12 rounded-full mr-4 border-2 border-planora-accent-blue/50"
            />
          ) : (
        ...
        {title && (
          <h4 className="text-md font-semibold text-white mb-2 truncate">
            {title}
          </h4>
        )}
