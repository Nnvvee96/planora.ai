...
const Footer = () => {
  return (
    <footer className="bg-planora-purple-dark border-t border-white/10 py-16 px-4 md:px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          <div>
            ...
            <p className="text-sm text-white/60 mb-6">
              Redefining travel planning with AI-powered conversation and personalized recommendations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/saved-trips" className="text-white/60 hover:text-white transition-colors">
                  Saved Trips
                </Link>
              </li>
              <li>
                <Link to="/chat" className="text-white/60 hover:text-white transition-colors">
                  Chat with AI
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-start text-white/60">
                ...
                <span>123 Travel Avenue<br />San Francisco, CA 94123</span>
              </li>
            </ul>
          </div>
        </div>
