...
const FaqAccordion: React.FC = () => {
  return (
    <Card className="bg-black/30 backdrop-blur-lg border border-white/10 shadow-xl">
      <CardHeader>
        <CardTitle className="text-2xl md:text-3xl font-semibold text-white">Frequently Asked Questions</CardTitle>
      </CardHeader>
      <CardContent>
        <Accordion type="single" collapsible className="w-full text-white/90">
          <AccordionItem value="item-1" className="border-white/20">
            <AccordionTrigger className="hover:text-planora-accent-blue text-left">How do I create a new trip?</AccordionTrigger>
          ...
          <AccordionItem value="item-2" className="border-white/20">
            <AccordionTrigger className="hover:text-planora-accent-blue text-left">Can I modify my trip after creating it?</AccordionTrigger>
            <AccordionContent className="text-white/80">
          ...
          <AccordionItem value="item-3" className="border-white/20">
            <AccordionTrigger className="hover:text-planora-accent-blue text-left">How do I upgrade my subscription?</AccordionTrigger>
            <AccordionContent className="text-white/80">
          ...
          <AccordionItem value="item-4" className="border-white/20">
            <AccordionTrigger className="hover:text-planora-accent-blue text-left">Is my payment information secure?</AccordionTrigger>
            <AccordionContent className="text-white/80">
          ...
          <AccordionItem value="item-5" className="border-b-0 border-white/20">
            <AccordionTrigger className="hover:text-planora-accent-blue text-left">How do I delete my account?</AccordionTrigger>
            <AccordionContent className="text-white/80">
