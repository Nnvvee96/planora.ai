    ...
    <div className="relative min-h-screen bg-planora-purple-dark flex flex-col text-white">
      ...
      <main className="flex-grow container mx-auto px-4 py-16 md:py-24">
        <div className="text-center mb-12 md:mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 gradient-text">Support Center</h1>
          <p className="text-lg md:text-xl text-white/80 max-w-2xl mx-auto">
            We're here to help! Fill out the form below or use our contact details.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <div className="relative mt-1">
                  ...
                  <Input id="subject" type="text" placeholder="Issue Subject" required className="pl-10 bg-black/40 border-white/20 focus:border-planora-accent-purple/50 focus:ring-planora-accent-purple/20" />
                </div>
              </div>
              <div>
                <Label htmlFor="message" className="text-white/90">Your Message</Label>
                <Textarea 
                  id="message" 
            ...
            <div className="space-y-3">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:support@getplanora.app" className="text-planora-accent-blue hover:text-planora-accent-blue/80 transition-colors">
