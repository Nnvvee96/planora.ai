...
export const ReviewsPage: React.FC = () => {
  ...
  return (
    <>
      ...
      <section
        id="reviews-page"
        className="py-16 md:py-24 bg-black/30 backdrop-blur-lg relative overflow-hidden text-white min-h-screen"
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 max-w-7xl">
          <div className="text-center mb-12">
            ...
            <p className="text-lg md:text-xl text-white/80 max-w-3xl mx-auto">
              Discover how Planora has transformed travel planning for users
              just like you. Real stories, real experiences.
            </p>
          </div>
          ...
          <div className="relative z-10 my-10 p-4 bg-black/10 backdrop-blur-md rounded-lg shadow-md border border-planora-accent-purple/50 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4">
            <div className="flex items-center space-x-2">
              <Label htmlFor="starFilterSelect" className="text-white/90">
                Filter by Rating:
              </Label>
              <Select
                ...
                onValueChange={(value) =>
                  setStarFilter(value === "" ? null : Number(value))
                }
            ...
            <div className="flex items-center space-x-2">
              <Label htmlFor="sortOrderSelect" className="text-white/90">
                Sort by:
              </Label>
              <Select
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayedReviews.map(({ id, ...reviewProps }) => (
              <ReviewCard
                key={id}
                {...reviewProps}
                className="bg-white/5 backdrop-blur-md shadow-xl"
              />
            ))}
          </div>
        </div>
