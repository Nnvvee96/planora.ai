        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/support" className="text-sm text-white/60 hover:text-white transition-colors">Support</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-8">
              <p className="text-xs text-white/40">© 2025 Planora.ai. All rights reserved.</p>
