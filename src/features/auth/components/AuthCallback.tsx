  ...
  useEffect(() => {
    ...
    const handleCallback = async () => {
      ...
      console.log("🔄 Processing auth callback...");
        ...
        console.log(
          "📋 Registration status from auth callback:",
          authResponse.registrationStatus,
        );

        if (isMounted) {
          if (
            authResponse.registrationStatus === "new_user" ||
            authResponse.registrationStatus === "incomplete_onboarding"
          ) {
            console.log(
              "📝 New user or incomplete onboarding, redirecting to onboarding",
            );
